...
class WindowGUI(wx.Frame):
    ...
    def initialise(self):
        ...
        wx.RadioButton(pnl, 1, 'All', (filterx,filtery),style=wx.RB_GROUP) #Filter Checkboxes
        wx.RadioButton(pnl, 1, 'Hourly', (2*filterx - 10, filtery))
        wx.RadioButton(pnl, 1, 'Type', (70, 160))
        wx.RadioButton(pnl, 1, 'Other', (3*filterx, filtery))
